...
public class SendSmsResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this SendSmsResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this SendSmsResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soar.hzfc.com/zfbz/gzf/websupport", "sendSmsResponse"));
