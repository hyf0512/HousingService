...
; (function ($) { 
    $.fn.jqLoading =function(option) {
        var defaultVal = {
            ...
            backgroundImage: "../../img/iconLoading.gif",//背景图片
            text: "正在加载中，请耐心等待....",//文字 
            width: 210,//宽度
            height: 50,//高度
            type:0 //0全部遮，1 局部遮
        ...
        function openLayer() {
           ...
           //图片及文字层
            ...
            content.append("<img style='vertical-align:middle;margin:"+(opt.height/4)+"px 0 0 5px;margin-right:5px;' src='" + opt.backgroundImage + "' /><span style='text-align:center; vertical-align:middle;position: relative;top:-23px;'>" + opt.text + "</span>");
        ...
        function openPartialLayer(obj) {
           /* var eheight = $(obj).css("height");//元素带px的高宽度
        	...
        	var eheight = $("#main_right_view").css("height");//元素带px的高宽度
            var ewidth = $("#main_right_view").css("width");
            var top = $("#main_right_view").offset().top; // 元素在文档中位置 滚动条不影响
            var left = $("#main_right_view").offset().left;
